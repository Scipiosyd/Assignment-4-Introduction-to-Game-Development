...
{
    public GridMap gridMap;                 // assign in inspector
    public GhostPathfinding ghostPath;      // assign in inspector
    ...
    IEnumerator FindPath(Vector3 startPos, Vector3 targetPos)
    {
        ...
        ghostPath.FinishedProcessingPath(waypoints, pathSuccess);
        yield return null;
    }
    ...
    {
        if (path.Count == 0) return new Vector3[0];
